...
description: "Security proxy daemon for MCP servers — authentication, rate limiting, PII detection, and audit logging. 97% detection rate across 7,095 attack scenarios."
date: "2026-04-07"
...
Then point your MCP client at m0lz.03 instead of the upstream server.
