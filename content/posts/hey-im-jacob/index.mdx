...
**[Case Pilot](https://github.com/jmolz/case-pilot)** — Open-source AI agent that monitors court cases on Tyler Tech, tracks deadlines, analyzes legal theory, and drafts filings autonomously. *Python, Claude API*
...
Read the framework: [github.com/jmolz/pice-framework](https://github.com/jmolz/pice-framework)
