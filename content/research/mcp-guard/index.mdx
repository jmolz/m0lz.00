---
title: "MCP-Guard Research"
description: "Benchmark methodology, threat modeling, and security analysis for the MCP-Guard proxy daemon."
project: "m0lz.03"
author: "Jacob Molz"
date: "2026-04-10"
sections:
...
**Complementary MCP security benchmarks.** These two papers evaluate agent-layer resilience against malicious MCP server instructions — a distinct but neighboring threat model to MCP-Guard's transport-layer proxy scope.
