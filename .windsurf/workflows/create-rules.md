...
If this is a new project with a PRD but no code yet, research:
...
Use the template at `.claude/templates/CLAUDE-template.md` as the output structure — fill in every section with real data from the codebase analysis.
