...
Use the template at `.claude/templates/plan-template.md` as the output structure — fill in every section with real data from the research.
...
1. **Set the tier** based on scope:
   - **Tier 1** (1 pass): Bug fixes, simple endpoints, UI tweaks
   - **Tier 2** (multi-pass): New features touching multiple domains, integrations, schema changes
   - **Tier 3** (agent team): New pipeline phases, agent types, architectural changes
