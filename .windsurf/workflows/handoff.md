...
Save to `HANDOFF.md` in the project root. Use the template at `.claude/templates/HANDOFF-template.md` as the structure — fill in every section with real data from reconciliation + current session.
